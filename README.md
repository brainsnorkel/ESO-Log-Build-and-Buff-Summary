...
[Features](#-features) • [Quick Start](#-quick-start) • [Installation](docs/user-guide/INSTALL.md) • [Usage](docs/user-guide/USAGE.md) • [Documentation](docs/) • [Contributing](CONTRIBUTING.md)
...
For detailed documentation, see [Action Bar Integration](docs/features/ACTION_BAR_INTEGRATION.md).
...
### User Documentation
- **[Installation Guide](docs/user-guide/INSTALL.md)** - Complete installation instructions
- **[Usage Guide](docs/user-guide/USAGE.md)** - Detailed usage examples
- **[Discord Webhook Setup](docs/user-guide/DISCORD_WEBHOOK.md)** - Configure Discord integration

### Features
- **[Action Bar Integration](docs/features/ACTION_BAR_INTEGRATION.md)** - How action bars work
- **[Discord Improvements](docs/features/FEATURE_DISCORD_URLS.md)** - Latest Discord features
- **[Web Scraping](docs/features/WEB_SCRAPING_RESULTS.md)** - Implementation details
...
For a complete index, see the [Documentation Index](docs/INDEX.md).
