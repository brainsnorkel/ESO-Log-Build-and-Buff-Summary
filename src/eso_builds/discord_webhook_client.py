...
class DiscordWebhookClient:
    ...
    async def post_individual_fights(self, encounters: list, report_title: str, log_url: str, include_wipes: bool = False, score: float = None, vitality: int = None) -> bool:
        """
        ...
        Args:
            ...
            score: Trial score (optional)
            vitality: Vitality value (optional)
        ...
        try:
            ...
            summary_embed = self._create_summary_embed(report_title, log_url, total_kills, total_wipes, score, vitality)
    ...
    def _create_summary_embed(self, report_title: str, log_url: str, total_kills: int, total_wipes: int = 0, score: float = None, vitality: int = None) -> Dict[str, Any]:
